 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} tromb - tromb color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.tromb.ansi, ...soft.tromb.brightOther];
